		...
		<ul
			...
			<li class="nav-item"><a class="nav-link collapsed" href="#"
				...
				aria-expanded="true" aria-controls="collapsePages"> <i
					class="fas fa-fw fa-folder"></i> <span>서비스</span>
			</a>
				<div id="collapsePages" class="collapse"
					aria-labelledby="headingPages" data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						<h6 class="collapse-header">직원메뉴</h6>
						<a class="collapse-item" href="forgot-password.html">내 실적 보기</a>
						<a class="collapse-item" href="forgot-password.html">내 회원 관리</a>
						<div class="collapse-divider"></div>
						<h6 class="collapse-header">마스터메뉴</h6>
						<a class="collapse-item" href="404.html">매출액</a>
						<a class="collapse-item" href="blank.html">회원리스트 관리</a>
						<a class="collapse-item" href="blank.html">직원관리</a>
					</div>
				</div></li>
			...
			<footer class="sticky-footer bg-white">
				<div class="container my-auto">
					<div class="copyright text-center my-auto">
						<span>Copyright &copy; OCEAN CAR 2019</span>
					</div>
				</div>
			</footer>
			<!-- End of Footer -->
